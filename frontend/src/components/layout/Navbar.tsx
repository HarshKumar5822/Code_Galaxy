...
import { Code2, Menu, X, User, LogIn, Settings, LayoutDashboard, LogOut } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
            ...
            {isLoggedIn ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56 glass-dark border-border/50">
                  ...
                  <DropdownMenuSeparator className="bg-border/50" />
                  <DropdownMenuItem onClick={onLogout} className="cursor-pointer text-destructive focus:bg-destructive/20 focus:text-destructive">
